<template>
        ...
        <div class="col-xs-12 col-lg-4 col-md-6">
          <div class="panel-container">
            <div id="location-form">
              ...
              <button class="btn btn-primary" @click="displayDataLower">
                Calculate Emissions
              </button>
              ...
              <div v-if="electricDistanceResult || petrolDistanceResult">
                <p class="co2-saved">
                ...
                <div class="details">
                  ...
                  <p>
                    ...
                    <span class="text-success"
                      ><b>{{ electricDistanceResult }}</b></span
                    >
                  </p>
                  <p>
                    Petrol Car CO2 Emission:
                    <span class="text-danger"
                      ><b>{{ petrolDistanceResult }}</b></span
                    >
                  </p>
                </div>
              </div>
  ...
  const API_KEY = "HP6M80CJV14M05MHP43PBSX1JAY3";
  
  const lowermed_ID = "be9c4990-6018-422d-87a2-f6f21ad5fc39"; //https://www.climatiq.io/data/emission-factor/be9c4990-6018-422d-87a2-f6f21ad5fc39
  const EVlower_ID = "f35e5761-6a58-4b86-a153-fc98f75cc165"; //https://www.climatiq.io/data/emission-factor/f35e5761-6a58-4b86-a153-fc98f75cc165
  /**const EVupper_ID = "a876195e-0200-48cc-b8d3-dc97f9c43aa4"; // https://www.climatiq.io/data/emission-factor/a876195e-0200-48cc-b8d3-dc97f9c43aa4
  const uppermed_ID = "7e03e5a3-e7ce-4c05-bc22-bb3e2b163ac9"; // https://www.climatiq.io/data/emission-factor/7e03e5a3-e7ce-4c05-bc22-bb3e2b163ac9
  const e_scooter_ID = "44e2c266-5593-4962-b2a5-81076897c00a"; //https://www.climatiq.io/data/emission-factor/44e2c266-5593-4962-b2a5-81076897c00a
  const motorbike_ID = "03785eda-242d-4d71-8687-3d6fe00c01cf"; //https://www.climatiq.io/data/emission-factor/03785eda-242d-4d71-8687-3d6fe00c01cf
  **/
  export default {
    data() {
      return {
    ...
    methods: {
      loadGoogleMaps(callback) {
        if (window.google) {
          ...
          script.src = `https://maps.googleapis.com/maps/api/js?key=AIzaSyAzhn8LHxt5g8hdqo6ITsvKI1NUKzYMNBg&callback=initMap`;
      ...
      clearForm() {
        ...
        this.fromMarker.setMap(null);
        this.toMarker.setMap(null);
        this.electricDistanceResult = "";
        this.petrolDistanceResult = "";
        this.savings = "";
      ...
      calculateEmissions(callback) {
        this.calculateDistance((travel) => {
          this.fetchLowermedEmissions(travel)
            .then((response) => {
              this.lowermedEmissions = response.data.co2e; // Store 'lowermed' emissions
              return this.fetchEveEmissions(travel); // Fetch 'EV' emissions
            })
            .then((response) => {
              this.eveEmissions = response.data.co2e; // Store 'EV' emissions
              callback(this.lowermedEmissions, this.eveEmissions);
            })
            .catch((error) => {
              console.error(error);
            });
      ...
      displayDataLower() {
        this.calculateEmissions((lowermed, eve) => {
          console.log({ lowermed, eve });
          let difference = lowermed - eve;
          let savings = (difference / lowermed) * 100;
          savings = savings.toFixed(2);
          this.electricDistanceResult = eve;
          this.petrolDistanceResult = lowermed;
